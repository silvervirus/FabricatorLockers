...
public class Fablocker
{
    ...
    {
        public static Texture2D HorizontalWallLockersTexture = RamuneLib.Utils.ImageUtils.GetTexture("Fabdoor");
        public static Texture2D HorizontalWallLockersspec = RamuneLib.Utils.ImageUtils.GetTexture("Fabdoor");
       // public static Texture2D HorizontalWallLockersnorm = RamuneLib.Utils.ImageUtils.GetTexture("submarine_locker_01_normal");
        ...
        public static PrefabInfo Info { get; } = PrefabInfo.WithTechType("FabLocker", "Fabricator Locker", "who needs fabricators when you can do it in a locker .", "English")
            .WithIcon(RamuneLib.Utils.ImageUtils.GetSprite("Fablocker"));
        ...
        public static void Register()
        {
            ...
            {   
                ...
                var dynamicLocker = obj.AddComponent<FabricatorLogic>();
            ...
            prefab.SetUnlock(TechType.UraniniteCrystal);
            ...
            prefab.SetRecipe(new RecipeData()
            {
                ...
                Ingredients = new List<CraftData.Ingredient>()
                {
                    ...
                    new CraftData.Ingredient(TechType.Knife, 1)
                },
            });
